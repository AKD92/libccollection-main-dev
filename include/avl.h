...
*/
int avl_treesort_sl(SList *list, int (*compare) (const void *arg1, const void *arg2));
 ...
 *      -1 if parameters are invalid
*/
int avl_treesort_sl_asc(SList *list, int (*compare) (const void *arg1, const void *arg2));
 ...
 *      -1 if parameters are invalid
*/
int avl_treesort_sl_desc(SList *list, int (*compare) (const void *arg1, const void *arg2));
